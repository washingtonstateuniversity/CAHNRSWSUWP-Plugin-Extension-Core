...
if ( version_compare( PHP_VERSION, '5.3', '<' ) ) {
	...
	add_action( 'admin_notices', create_function( '', "echo '<div class=\"error\"><p>" . __( 'CAHNRS WSUWP Plugin Extension Core requires PHP 5.3 to function properly. Please upgrade PHP or deactivate the plugin.', 'cahnrswsuwp-plugin-extension-core' ) . "</p></div>';" ) );
	return;
