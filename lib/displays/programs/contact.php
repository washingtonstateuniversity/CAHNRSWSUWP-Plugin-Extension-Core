...
<?php if ( ! empty( $program_contact['icon'] ) ) : ?><img src="<?php echo esc_url( ecore_get_plugin_url( 'lib/images/' . $program_contact['icon'] . '.png' ) ); ?>" height="75" width="75" class="extension-program-icon" /><?php endif; ?>
